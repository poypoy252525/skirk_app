...
String _$episodeSourcesHash() => r'591870b3f8467bf5b1b5b3a405c5efa264089b14';
...
class EpisodeSourcesFamily extends Family<AsyncValue<EpisodeSources>> {
  ...
  /// See also [episodeSources].
  EpisodeSourcesProvider call({required String episodeId, String? type}) {
    return EpisodeSourcesProvider(episodeId: episodeId, type: type);
  }
  ...
  EpisodeSourcesProvider getProviderOverride(
    ...
    return call(episodeId: provider.episodeId, type: provider.type);
  }
...
class EpisodeSourcesProvider extends AutoDisposeFutureProvider<EpisodeSources> {
  /// See also [episodeSources].
  EpisodeSourcesProvider({required String episodeId, String? type})
    : this._internal(
        (ref) => episodeSources(
...
class _EpisodeSourcesProviderElement
  ...
  @override
  String? get type => (origin as EpisodeSourcesProvider).type;
}

String _$hianimeEpisodeSourcesHash() =>
    r'b072b7f3e1bb88a941728a9db76faae7431a38a0';

/// See also [HianimeEpisodeSources].
@ProviderFor(HianimeEpisodeSources)
final hianimeEpisodeSourcesProvider =
    NotifierProvider<HianimeEpisodeSources, EpisodeSources?>.internal(
      HianimeEpisodeSources.new,
      name: r'hianimeEpisodeSourcesProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$hianimeEpisodeSourcesHash,
      dependencies: null,
      allTransitiveDependencies: null,
    );

typedef _$HianimeEpisodeSources = Notifier<EpisodeSources?>;
